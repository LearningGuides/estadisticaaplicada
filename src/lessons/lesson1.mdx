...
A continuación se organiza la unidad en lecciones breves y progresivas. Cada apartado corresponde a una lección centrada en un objetivo conceptual específico. Dependiendo de la naturaleza del contenido, se incorpora una sugerencia visual para facilitar la comprensión conceptual o una práctica breve en R para explorar el concepto mediante datos, cálculos, gráficos o simulaciones.
